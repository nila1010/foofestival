...
export default function SummeryAside({ resId, setTimeOut, regTickets, vipTickets, campSitePick, setGreenOpt, tents, setPage, page, totalPrice, info }) {
  return (
    <article className={`bg-textprim text-bgprim rounded-sm grid auto-rows-max p-5 ${page === 4 ? "grid-cols-2 justify-items-center" : ""} mt-4 lg:mt-0 min-w-[300px] max-w-[500px] mx-auto `}>
      <div>
